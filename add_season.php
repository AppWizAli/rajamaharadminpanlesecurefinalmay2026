...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Handle form submission and insert the new season into the database
}
                ...
                <div class="dashboard-header mb-4 p-3 rounded shadow-sm bg-white">
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div class="page-title">
                            ...
                            <small>Manage your seasons and dramas</small>
                        </div>
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="section-header-custom">
                        <h4 class="section-title-custom">ADD SEASON</h4>
                        <p class="section-subtitle-custom">Add All Types of Seasons</p>
                    </div>
                </div>

                <form action="submit_season.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="drama_id" value='<?php echo $_GET['drama_id']; ?>'>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input
                                ...
                                name="thumbnail"
                                type="text"
                                placeholder="https://example.com/season.jpg or uploads/thumbnails/season/file.jpg" />
                            <small class="form-text text-muted">Paste an image link/path or choose an image file below.</small>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <button type="submit" class="btn btn-custom-red">
                                <i class="fas fa-plus-circle me-1"></i> Add Season
                            </button>
                        </div>
                    </div>
