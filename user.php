...
<?php include "header.php"; ?>
				...
				<div class="dashboard-header mb-4 p-3 rounded shadow-sm bg-white">
					<div class="d-flex flex-wrap align-items-center justify-content-between">
						<div class="page-title">
							...
							<small>Fill the form below to add a new user to the system</small>
						</div>
          ...
          <div class="pd-20 card-box mb-30">
			<div class="clearfix">
				<div class="section-header-custom">
					<h4 class="section-title-custom">ADD USER</h4>
					<p class="section-subtitle-custom">Add new users to the platform</p>
				</div>
			</div>
	...
	<div class="form-group row">
		...
		<div class="col-sm-12 col-md-10">
			<button type="submit" class="btn btn-custom-red">Register</button>
		</div>
	</div>
